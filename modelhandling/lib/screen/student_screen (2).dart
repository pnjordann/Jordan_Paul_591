...
import 'package:modelhandling/controller/student_controller%20(5).dart';
...
class _StudentPageState extends State<StudentPage> {
  ...
  void loadStudents() async {
    ...
    try {
      // 2. Call controller.getStudents()
      final List<Student> loadedStudents = await controller.getStudents();

      // 3. Update students and filteredStudents
      setState(() {
        students = loadedStudents;
        filteredStudents = List.from(loadedStudents); // copy to allow filtering
      });
    } catch (e) {
      // Optional: Show error message to user
      print('Error loading students: $e');
      // You can also show a SnackBar here if you want
    } finally {
      // 4. Set isLoading to false
      setState(() {
        isLoading = false;
